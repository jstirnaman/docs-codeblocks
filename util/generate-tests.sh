...
function substituteCredentials {
  ...
  cat $srcfile | 
    ...
    sed "s/DATABASE_NAME/$INFLUX_DATABASE/g;" >> $outfile
}
...
function generateTestFile {
  ...
  echo "% Generated test file for $file" > $outfile
  echo "<!-- Do not commit this file to version control. -->" >> $outfile
  echo "<!-- Do not edit this file directly. Instead, edit $file and run 'make generate-tests'. -->" >> $outfile
